...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-50 min-w-[8rem] overflow-hidden rounded-[var(--radius-md)] border border-[var(--plum-border)] bg-[color-mix(in_srgb,var(--plum-panel)_92%,black_8%)] p-1 text-[var(--plum-text)] shadow-[0_18px_36px_rgba(0,0,0,0.34)] data-[state=open]:opacity-100 data-[state=closed]:opacity-0 data-[state=closed]:scale-95 data-[state=open]:scale-100 transition-opacity duration-150",
      className,
    )}
    {...props}
  />

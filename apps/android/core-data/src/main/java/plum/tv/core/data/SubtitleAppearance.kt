...
enum class SubtitleSize(val storageValue: String) {
    ...
    companion object {
        fun fromStorage(raw: String?): SubtitleSize = entries.find { it.storageValue == raw } ?: MEDIUM
    }
}
...
enum class SubtitlePosition(val storageValue: String) {
    ...
    companion object {
        fun fromStorage(raw: String?): SubtitlePosition = entries.find { it.storageValue == raw } ?: BOTTOM
    }
}

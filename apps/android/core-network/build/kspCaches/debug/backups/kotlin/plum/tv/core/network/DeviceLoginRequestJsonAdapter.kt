...
public class DeviceLoginRequestJsonAdapter(
  moshi: Moshi,
) : JsonAdapter<DeviceLoginRequest>() {
  ...
  public override fun toString(): String = buildString(40) {
      append("GeneratedJsonAdapter(").append("DeviceLoginRequest").append(')') }

  public override fun fromJson(reader: JsonReader): DeviceLoginRequest {
  ...
  public override fun toJson(writer: JsonWriter, value_: DeviceLoginRequest?): Unit {
    if (value_ == null) {

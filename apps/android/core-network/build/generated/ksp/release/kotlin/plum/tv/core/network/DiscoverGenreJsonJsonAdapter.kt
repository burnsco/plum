...
public class DiscoverGenreJsonJsonAdapter(
  moshi: Moshi,
) : JsonAdapter<DiscoverGenreJson>() {
  ...
  public override fun toString(): String = buildString(39) {
      append("GeneratedJsonAdapter(").append("DiscoverGenreJson").append(')') }

  public override fun fromJson(reader: JsonReader): DiscoverGenreJson {
    var id: Int? = null
    ...
    reader.endObject()
    return DiscoverGenreJson(
        id = id ?: throw Util.missingProperty("id", "id", reader),
        name = name ?: throw Util.missingProperty("name", "name", reader)
    )
  }

  public override fun toJson(writer: JsonWriter, value_: DiscoverGenreJson?): Unit {
    if (value_ == null) {

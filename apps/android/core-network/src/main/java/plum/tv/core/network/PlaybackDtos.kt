...
data class CreatePlaybackSessionPayloadJson(
    ...
    ) val clientCapabilities: ClientPlaybackCapabilitiesJson? =
        null,
    @param:Json(
        name = "burnEmbeddedSubtitleStreamIndex"
    ) val burnEmbeddedSubtitleStreamIndex: Int? =
        null
)
...
data class PlaybackSessionJson(
    ...
    ) val embeddedSubtitles: List<EmbeddedSubtitleJson>? = null,
    @param:Json(
        name = "burnEmbeddedSubtitleStreamIndex"
    ) val burnEmbeddedSubtitleStreamIndex: Int? =
        null,

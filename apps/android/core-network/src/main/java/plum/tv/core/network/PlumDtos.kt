...
data class EmbeddedSubtitleJson(
    ...
    @param:Json(
        name = "deliveryModes"
    ) val deliveryModes: List<EmbeddedSubtitleDeliveryModeJson>? = null,
    @param:Json(name = "preferredWebDeliveryMode") val preferredWebDeliveryMode: String? = null,
    @param:Json(
        name = "preferredAndroidDeliveryMode"
    ) val preferredAndroidDeliveryMode: String? = null
)
...
data class MediaItemJson(
    ...
    @param:Json(name = "embeddedSubtitles") val embeddedSubtitles: List<EmbeddedSubtitleJson> =
        emptyList(),
    @param:Json(
        name = "embeddedAudioTracks"
    ) val embeddedAudioTracks: List<EmbeddedAudioTrackJson> =
        emptyList(),
...
data class HomeDashboardJson(
    @param:Json(name = "continueWatching") val continueWatching: List<ContinueWatchingEntryJson> =
        emptyList(),
    ...
    ) val recentlyAddedMovies: List<RecentlyAddedEntryJson> =
        emptyList(),
...
data class DiscoverItemJson(
    ...
    @param:Json(name = "vote_average") val voteAverage: Double? = null,
    @param:Json(name = "library_matches") val libraryMatches: List<DiscoverLibraryMatchJson> =
        emptyList(),
...
@JsonClass(generateAdapter = true)
data class RemoveDownloadPayloadJson(@param:Json(name = "id") val id: String)
